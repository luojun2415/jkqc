...
$(function () {
    ...
    $('.a_jump').click(function () {
        ...
        if ($(this).attr('hide-data') === 'true') {//无数据时也可以使用的功能
            ...
            query = form.find('input,select,textarea').serializeArray();
        }
        ...
        setCookie('prids',JSON.stringify(query));
        
    	location.href = target;
    });
  //a_jump2请求
    $('.a_jump1').click(function () {
    	var target, query, form;
        var target_form = $(this).attr('target-form');
        var that = this;
    	target = $(this).attr('href');
        ...
        setCookie('areanum',JSON.stringify(query));
        
    	location.href = target;
    });
    $('.a_jump2').click(function () {
    	var target, query, form;
        var target_form = $(this).attr('target-form');
        var that = this;
    	target = $(this).attr('href');
        ...
        setCookie('templateid',JSON.stringify(query));
        ...
        if (($(this).attr('type') == 'submit') || (target = $(this).attr('href')) || (target = $(this).attr('url'))) {
            ...
            if ($(this).attr('hide-data') === 'true') {//无数据时也可以使用的功能
                ...
                if ($(this).attr('url') !== undefined) {
                    ...
                    target = form.get(0).action;
                    //ie兼容问题
                    var weburl = window.location.protocol+'//'+window.location.host+'/'; // http:localhost:81
                    if(weburl==target){
                    	target = document.URL; 
                    }
                }
